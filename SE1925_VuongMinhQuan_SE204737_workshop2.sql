...
drop database SE1925_VuongMinhQuan_SE204737_workshop2
go
-- Tạo database ProductIntro
create database SE1925_VuongMinhQuan_SE204737_workshop2
go
use SE1925_VuongMinhQuan_SE204737_workshop2
go
...
create table orders(
    ...
    custAddr nvarchar(200),
    custPhone nvarchar(20),
    deliveredDate datetime,
    totalValue int,
    orderState nvarchar(50),
	paymentMethods nvarchar(50)
)
go
